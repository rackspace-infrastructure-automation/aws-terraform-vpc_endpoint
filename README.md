...
| ecr\_api\_endpoint\_enable | Enable/Disable the ecr.api VPC endpoint. Allowed values: true, false | `string` | `false` | no |
| ecr\_api\_private\_dns\_enable | Enable/Disable private dns on the ecr.api endpoint. Allowed values: true, false | `string` | `false` | no |
| ecr\_dkr\_endpoint\_enable | Enable/Disable the ecr.dkr endpoint. Allowed values: true, false | `string` | `false` | no |
| ecr\_dkr\_private\_dns\_enable | Enable/Disable private dns on the ecr.dkr endpoint. Allowed values: true, false | `string` | `false` | no |
...
| route\_tables\_ids\_list | List of Route Table ID's for each AZ | `list` | `[]` | no |
...
| security\_group\_ids\_list | List of Security Group ID's for the endpoints. | `list` | `[]` | no |
...
| subnet\_ids\_list | List of Subnets to assoicate with Inteface endpoints. | `list` | `[]` | no |
