output "codebuild_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.codebuild_endpoint.*.id, [""]),
    0,
  )
}
...
output "codebuild_fips_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.codebuild_fips_endpoint.*.id, [""]),
    0,
  )
}
...
output "ec2messages_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.ec2messages_endpoint.*.id, [""]),
    0,
  )
}
...
output "elasticloadbalancing_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.elasticloadbalancing_endpoint.*.id, [""]),
    0,
  )
}
...
output "execute_api_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.execute_api_endpoint.*.id, [""]),
    0,
  )
}
...
output "kinesis_streams_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.kinesis_streams_endpoint.*.id, [""]),
    0,
  )
}
...
output "monitoring_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.monitoring_endpoint.*.id, [""]),
    0,
  )
}
...
output "sagemaker_runtime_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.sagemaker_runtime_endpoint.*.id, [""]),
    0,
  )
}
...
output "secretsmanager_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.secretsmanager_endpoint.*.id, [""]),
    0,
  )
}
...
output "servicecatalog_vpc_endpoint_id" {
  ...
  value = element(
    coalescelist(aws_vpc_endpoint.servicecatalog_endpoint.*.id, [""]),
    0,
  )
}
